---
name: pinecone
description: Use Pinecone through the PowerProfile Apps connector when the user requests actions or data from this service.
---
...
1. Search for tools relevant to the user's request and constrain discovery to toolkit `pinecone`.
